...
infile='TajimaD_by-gene_8Mixed.tsv'

essential_file='essential.csv' #essential genes - from Winzeler et al., 1999


##figname='8Mixed_TD_resample_barseq_tophits.png'
...
##
##figname='8Mixed_TD_resample_popgen_hits.png'
