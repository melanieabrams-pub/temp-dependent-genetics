...
infile='TajimaD_by-gene_1Wine.tsv'

essential_file='essential.csv' #essential genes - from Winzeler et al., 1999


figname='M3_TD_resample_barseq_tophits.png'
...
figname='TD_resample_popgen_hits.png'
...
print('candidate median',candidates['TajimaD'].median())
print('genome median',df['TajimaD'].median())
